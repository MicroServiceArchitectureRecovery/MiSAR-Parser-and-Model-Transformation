...
def buttonStuff(inputClass):
    if inputClass.name == "MiSAR Parser":
        if os.path.isfile((os.path.expanduser('~') + "\\MisAR\\TransformationEngineNecessities\\source\\PSM.ecore")) == False:
            ...
            if MisarChecker == "yes":
                        ...
                        if parserInstaller("MiSAR") == True:
                            messagebox.showinfo("Success!",
                                                "The operation completed successfully!\nThe Parser has been installed! It has been saved at: " + os.path.expanduser(
                                                    '~') + "\\MiSAR\\ParserNecessities\\MisarParserGUI.py")
                ...
                mainWindow.destroy()
                subprocess.call(['python', (os.path.expanduser('~') + "\\MisAR\\ParserNecessities\\MisarParserGUI.py")])
...
def misar_updater():
    if checkInternet():
        if checkIfModulesAreInstalled(None):
            if os.path.isfile((os.path.expanduser('~') + "\\MisAR\\TransformationEngineNecessities\\source\\PSM.ecore")) == True:
                ...
                if parserInstaller("MiSARTemp") == True:
                    ...
                    currentVersion = datetime.fromtimestamp(
                        (os.path.getctime((os.path.expanduser('~') + "\\MisAR\\TransformationEngineNecessities\\source\\PSM.ecore"))))
