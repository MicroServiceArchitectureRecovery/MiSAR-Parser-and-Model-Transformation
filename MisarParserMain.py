...
class metamodelItem():
    def __init__(self, javaInstance, ContainerNameInput, BuildFieldInput, ImageFieldInput, GeneratesLogsInput, ParentProjectNameInput, ArtifactFileNameInput, ProjectArtifactIDInput,
                 ElementIdentifierInput, ElementProfileInput, JsonSchemaInput, PackageNameInput, ParameterNameInput, ParameterOrderInput, IsPrimitiveInput):
        self.javaInstance = javaInstance
        self.ContainerNameInput = ContainerNameInput
        self.BuildFieldInput = BuildFieldInput
        self.ImageFieldInput = ImageFieldInput
        self.GeneratesLogsInput = GeneratesLogsInput
        self.ParentProjectNameInput = ParentProjectNameInput
        self.ArtifactFileNameInput = ArtifactFileNameInput
        self.ProjectArtifactIDInput = ProjectArtifactIDInput
        self.ElementIdentifierInput = ElementIdentifierInput
        self.ElementProfileInput = ElementProfileInput
        self.JsonSchemaInput = JsonSchemaInput
        self.PackageNameInput = PackageNameInput
        self.ParameterNameInput = ParameterNameInput
        self.ParameterOrderInput = ParameterOrderInput
        self.IsPrimitiveInput = IsPrimitiveInput
    """
    def metamodelItemBuilder(self, javaInstance, ContainerNameInput, BuildFieldInput, ImageFieldInput, GeneratesLogsInput, ParentProjectNameInput, ArtifactFileNameInput, ProjectArtifactIDInput,
                 ElementIdentifierInput, ElementProfileInput, JsonSchemaInput, PackageNameInput, ParameterNameInput, ParameterOrderInput, IsPrimitiveInput):
        self.JavaInsta

        return self.javaInstance
    """
    def metamodelItemBuilder(self):
