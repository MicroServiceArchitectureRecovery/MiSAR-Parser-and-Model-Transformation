...
MiSAR consists of a parser that creates a Platform Specific Model from existing systems and a Model Transformation engine that transforms Platform Specific Models into Platform Independent Model instances. An instance of a MiSAR Platform Independent Model is the recovered architectural model of the implemented microservice system. 
...
| Eclipse             | Eclipse IDE for Java Developers or Eclipse Modeling Tools | Running the QVT transformation workflow from PSM to PIM    |
| QVTo                | QVTo 3.11.2                                               | Transforming PSM models into PIM models                    |
| EMF SDK             | Eclipse 2026-06 update site                               | Sample Reflective Ecore Model Editor and EMF model tooling |
